...
// this is the specific code for scarf "mandelbrot21: Spiraling Into Control" https://knityak.com
...
// Use this to zoom in. 
float w = 1.0/990.0; //z-axis zoom. try changing the 990.0 value up or down to zoom in or out.
...
ymin -=0.68811; // y-axis,  start with 0.0, modified here to move along y-axis

// Maximum number of iterations for each point on the complex plane: more or less wispy/detailed
int maxiterations = 121; // lower value is less iterations, higher value is more iterations
...
saveBytes("mandelbrot_21.ppm", outp); // rename this file to save multiple images to sketch
