...
// this is the specific code for scarf "mandelbrot19: fern-tastic" https://knityak.com
...
// Use this to zoom in. 
float w = 1.0/350.0; //z-axis zoom. try changing the value up or down to zoom in or out.
...
xmin -=0.213;  // x-axis, start with 1.0, modified here to move along x-axis
ymin -=0.68695; // y-axis,  start with 0.0, modified here to move along y-axis

// Maximum number of iterations for each point on the complex plane: more or less wispy/detailed
int maxiterations = 110; // lower value is less iterations, higher value is more iterations
...
saveBytes("mandelbrot_19.ppm", outp); // rename this file to save multiple images to sketch
