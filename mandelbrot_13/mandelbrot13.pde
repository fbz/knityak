...
// this is the specific code for scarf "mandelbrot13: clouds in my coffee“
...
// Use this to zoom in 
float w = 1.0/12.0; // z-axis zoom. try changing the 37.0 value up or down to zoom in or out.
float h = w; // leave this for now

// Use this to move around the Mandelbrot rendering
float xmin = (-w/0.212); // initial value, modify here or directly below
float ymin = (-h/0.72); // initial value, modify here or directly below
xmin -=.8;  // x-axis, start with 1.0
ymin -=0.1596; // y-axis,  start with 0.0

// Maximum number of iterations for each point on the complex plane: makes it more wispy/detailed
int maxiterations = 73; //lower value is less iterations, higher value is more iterations
...
saveBytes("mandelbrot_13.ppm", outp); // rename this file to save multiple images to sketch folder
