...
// this is the specific code for scarf "mandelbrot15: de-orbiting satellites" https://knityak.com
...
// Use this to zoom in. 
float w = 1.0/6100.0; //z-axis zoom. try changing the 6100.0 value up or down to zoom in or out.
...
xmin -=(-0.25675);  // x-axis, start with 1.0, modified here to move along x-axis
ymin -=0.0009225; // y-axis,  start with 0.0, modified here to move along y-axis

// Maximum number of iterations for each point on the complex plane: more or less wispy/detailed
int maxiterations = 480; // lower value is less iterations, higher value is more iterations
...
saveBytes("mandelbrot_15.ppm", outp); // rename this file to save multiple images to sketch
