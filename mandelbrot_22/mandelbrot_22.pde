...
// this is the specific code for scarf "mandelbrot22: spiral galaxies".
...
// Use this to zoom in. 
float w = 1.0/2100.0; // z-axis zoom. try changing the larger value up or down to zoom in or out.
float h = w; // leave this for now

// Use this to move around the mandelbrot rendering
float xmin = (-w/10.4); // initial value, modify here or directly below
float ymin = (-h/2.0158); // initial value, modify here or directly below
xmin -=.8;  // x-axis, start with 1.0
ymin -=0.153289; // y-axis,  start with 0.0

// Maximum number of iterations for each point on the complex plane: makes it more or less wispy/detailed
int maxiterations = 160; //lower value is less iterations, higher value is more iterations
...
saveBytes("mandelbrot_22.ppm", outp); // rename this file to save multiple images to the sketch folder
