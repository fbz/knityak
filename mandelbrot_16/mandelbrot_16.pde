...
// this is the specific code for scarf "mandelbrot16: bolts of lightning" https://knityak.com
...
// Use this to zoom in. 
float w = 1.0/270.0; //z-axis zoom. try changing the 6100.0 value up or down to zoom in or out.
...
xmin -=(1.122);  // x-axis, start with 1.0, modified here to move along x-axis
ymin -=0.28; // y-axis,  start with 0.0, modified here to move along y-axis

// Maximum number of iterations for each point on the complex plane: more or less wispy/detailed
int maxiterations = 85; // lower value is less iterations, higher value is more iterations
...
saveBytes("mandelbrot_16.ppm", outp); // rename this file to save multiple images to sketch
